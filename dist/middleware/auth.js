...
var auth = (0, asyncHandler_1.default)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
            case 0:
                ...
                if (!authHeader || !authHeader.startsWith("Bearer "))
                    throw new customError_1.default(errorMessages_1.AUTHENTICATION_REQUIRED, statusCodes_1.UNAUTHORIZED);
                ...
                try {
                    ...
                    throw new customError_1.default(errorMessages_1.AUTHENTICATION_INVALID, statusCodes_1.UNAUTHORIZED);
                }
                // Throw error if payload doesn't exist or isn't the right format.
                if (!payload || typeof payload !== 'object' || !payload.userId)
                    throw new customError_1.default(errorMessages_1.AUTHENTICATION_INVALID, statusCodes_1.UNAUTHORIZED);
                return [4 /*yield*/, data_source_1.userRepository.findOne({
                        where: {
                            id: payload.userId,
                        },
                    })
